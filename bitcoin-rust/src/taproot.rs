...
fn dummy_unspent_transaction_output<C: Verification>(
    ...
    let out_point = OutPoint {
        txid: Txid::all_zeros(), // invalid. but can be used for dummy transaction & demo purposes.
        vout: 0,
    };
...
pub fn taproot() {
    ...
    // Input for the transaction we are constructing
    let input = TxIn {
        previous_output: dummy_out_point,
        script_sig: ScriptBuf::default(), // For a p2tr script_sig is empty
        sequence: Sequence::ENABLE_LOCKTIME_NO_RBF,
        witness: Witness::default(), // Filled after signing
    };
